...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="nav-images/mdi_weights.png">
    ...
    <link rel="stylesheet" href="styles/in-touch.css">
    <link rel="stylesheet" href="styles/message-us.css">
...
<body>
    ...
    <nav class="navbar">
        ...
        <div class="right-section">
            ...
            <a href="#faqs">FAQ's</a>
            <button><a href="../../sign_up.html">Join Us</a></button>
        </div>
    </nav>
    <!--Navbar ends-->
    ...
    <section id="home">
        ...
        <div class="right-section--home">
            <img src="home-images/Ellipse 1.png" class="ellipse-1">
            <img src="home-images/Ellipse 2.png"  class="ellipse-2">
        </div>
    </section>
    <!--Home section ends-->
    ...
    <div class="bar">
        <nav>
            <div>
                <img src="sport-icons/simple-icons_nike.png" class="sport--icon">
                <img src="sport-icons/simple-icons_jordan.png" class="sport--icon">
                <img src="sport-icons/token_mtv.png" class="sport--icon">
                <img src="sport-icons/gg_adidas.png" class="sport--icon">
            </div>
        </nav>
    </div>
    ...
    <section class="fitness" id="fitness">
        ...
        <div class="left-section--fitness">
            <img src="fitness-images/fitness.png" alt="">
        </div>
            ...
            <div class="in--touch--links">
                ...
                <div class="in--touch--title">
                    <div class="in--touch--img">
                        <img src="in-touch-images/Address.png" alt="">
                    </div>
                ...
                <div class="in--touch--title middle">
                    <div class="in--touch--img">
                        <img src="in-touch-images/phone.png" alt="">
                    </div>
                    <div class="in--touch--img--text">
                        <p>
                ...
                <div class="in--touch--title">
                    <div class="in--touch--img">
                        <img src="in-touch-images/email.png" alt="">
                    </div>
                    <div class="in--touch--img--text">
                        <p>
